\ eforth-v-7-20--plus-USART6-jan-26-2021-a.fs
\ Tue Jan 26 17:35:44 UTC 2021
\ slight edits - commented at least one line of dead code

\ old:
\ eforth-v-7-20--plus-USART6-dec-20-2020-c.fs
\ older:
\ short-upload-aa.fs
\ mono-lab-c.fs
\ ." Sun Dec 20 17:43:55 UTC 2020 "
\ old:
...
\ : boutsent?  BEGIN USART6_SR_TXE? \ commented outsent
\   2B EMIT UNTIL -1 ;
: outsent_TC?
  BEGIN
    USART6_SR_TC?
...
: atef=(1) \ Blue text for Lumex - want this almost always
 ...
 line_end
 s_atd1=() ;
: at80=(0,0,4) \ explain this at80 is positional write?
 29 34 2C 30   2C 30 28 3D   30 38 74 61
 outc outc outc outc outc outc outc outc
 outc outc outc outc
 line_end
 s_atd1=() ;
: at80=(0,1,0) \ explain this
 29 30 2C 31   2C 30 28 3D   30 38 74 61
 C 1 - FOR outc NEXT
 line_end
 s_atd1=() ;
: at80=(0,2,C) \ explain this
 29 43 2C 32   2C 30 28 3D   30 38 74 61
 C 1 - FOR outc NEXT
 line_end
 s_atd1=() ;
: sent 18 delay ; \ never do remember what this is
: said \ explain this
  atef=(1) sent
  at80=(0,0,4) sent
  at80=(0,1,0) sent
...
: beflogo ( -- ) \ send eForth v7.20 to Lumex 96x8 RGB LED matrix
...
: signon
  ...
  atef=(1) sent \ make it blue - default is white
  9 delay \ was 11
  eflogo
